...
F1GENZ.superFS = {
  ...
  fs_click: function () {
    $("body").on("click", ".home-fsale-tab .home-fsale-tab-item", function () {
      ...
      $(".home-fsale-head-item")
        ...
        .siblings()
        .removeClass("active");
      $(".home-fsale-banner-item")
        .eq(index)
        .addClass("active")
        .siblings()
        .removeClass("active");
      $(".home-fsale-body-item")
        .eq(index)
        .addClass("active")
        .siblings()
        .removeClass("active");
      ...
      if (window.F1GENZ_vars.shop.featured.super_fs.slider)
        if (
          !$(
            `.home-fsale-body-item:nth-child(${
              index + 1
            }) .home-fsale-body-item-data`
  ...
  fs_tab_current: function () {
    ...
    if (current == -1) {
      ...
      var newTime = $(".home-fsale-tab-item")
        .eq(current)
        .next()
        .attr("data-time");
...
F1GENZ.Index = {
  init: function () {
    ...
    if (navigator.userAgent.indexOf("Chrome-Lighthouse") === -1) {
      ...
      $(
        ".home-collections .home-collections-head .home-collections-head-catalog ul li:first-child a"
      ).trigger("click");
      $(".home-product-tab .home-product-tab-head ul li:first-child a").trigger(
        "click"
      );
    }
  },
  home_slider: function () {
    ...
    if (navigator.userAgent.indexOf("Chrome-Lighthouse") === -1) {
      ...
      F1GENZ.Helper.productSlider(
        ...
        1,
        1,
        { infinite: true, autoplay: true, fade: true }
      );
    }
  },
  ...
  home_tab: function () {
    $("body").on(
      "click",
      ".home-product-tab .home-product-tab-head ul li a",
      function (e) {
        e.preventDefault();
        var parent = $(this).parent();
        var index = parent.index();
        parent.addClass("active").siblings().removeClass("active");
        $(".home-product-tab-head-right a")
          .eq(index)
          .addClass("active")
          .siblings()
          .removeClass("active");
        $(".home-product-tab-body-item")
          .eq(index)
          .addClass("active")
          .siblings()
          .removeClass("active");
        ...
        if (
          !$(
            `.home-product-tab-body-item:nth-child(${
              index + 1
            }) .home-product-tab-body-item-data`
          ).hasClass("slick-slider")
        ) {
          F1GENZ.Helper.productSlider(
            `.home-product-tab-body-item:nth-child(${
  ...
  home_pos: function () {
    $("body").on(
      ...
      function () {
        ...
        else that.parent().toggleClass("left");

        if (window_width < 991)
          $("body, html").addClass("open-noscroll open-overplay");
      }
    );
  },
  homeTab: () => {
    $("body").on(
      "click",
      ".home-collections .home-collections-head .home-collections-head-catalog ul li a",
      function (e) {
        e.preventDefault();
        ...
        $.ajax({
          ...
          success: function (data) {
            ...
            if ($(window).width() < 767) {
              $(".home-collections .home-collections-body").removeClass(
