    ...
    <div class="container">
        <div class="home-product-tab-head">
            <div class="home-product-tab-head-left">
                <ul>
                    <li>
                        <a href="collections/ban-an.html" aria-label="Bàn ăn">
                            <img class="lazyload w-100" width="64" height="64"
                                    src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII="
                                    data-src="//theme.hstatic.net/200000584705/1000969925/14/home_product_tab_item_icon_1.png" alt="Bàn ăn - Icon"/>
                            <strong>Bàn ăn <span>6 sản phẩm</span></strong>
                        </a>
                    </li>
                    <li>
                        <a href="collections/ghe-an.html" aria-label="Ghế ăn">
                            <img class="lazyload w-100" width="64" height="64"
                                    src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII="
                                    data-src="//theme.hstatic.net/200000584705/1000969925/14/home_product_tab_item_icon_2.png" alt="Ghế ăn - Icon"/>
                            <strong>Ghế ăn <span>9 sản phẩm</span></strong>
                        </a>
                    </li>
                    <li>
                        <a href="collections/tu-quan-ao.html" aria-label="Tủ quần áo">
                            <img class="lazyload w-100" width="64" height="64"
                                    src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII="
                                    data-src="//theme.hstatic.net/200000584705/1000969925/14/home_product_tab_item_icon_3.png" alt="Tủ quần áo - Icon"/>
                            <strong>Tủ quần áo <span>5 sản phẩm</span></strong>
                        </a>
                    </li>
                    <li>
                        <a href="collections/ke-treo-tuong.html" aria-label="Kệ treo tường">
                            <img class="lazyload w-100" width="64" height="64"
                                    src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII="
                                    data-src="//theme.hstatic.net/200000584705/1000969925/14/home_product_tab_item_icon_4.png" alt="Kệ treo tường - Icon"/>
                            <strong>Kệ treo tường <span>4 sản phẩm</span></strong>
                        </a>
                    </li>
                    <li>
                        <a href="collections/den-de-ban.html" aria-label="Đèn để bàn">
                            <img class="lazyload w-100" width="64" height="64"
                                    src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII="
                                    data-src="//theme.hstatic.net/200000584705/1000969925/14/home_product_tab_item_icon_5.png" alt="Đèn để bàn - Icon"/>
                            <strong>Đèn để bàn <span>6 sản phẩm</span></strong>
                        </a>
                    </li>
                </ul>
            </div>
            <div class="home-product-tab-head-right has-spin">
                <a href="collections/ban-an.html" aria-label="Bàn ăn">
                    <img class="lazyload w-100" width="1920" height="640"
                            ...
                            data-src="//theme.hstatic.net/200000584705/1000969925/14/home_product_tab_item_banner_1.png" alt="Bàn ăn - Banner"/>
                </a>
                <a href="collections/ghe-an.html" aria-label="Ghế ăn">
                    <img class="lazyload w-100" width="1920" height="640"
                            src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAMAAAABCAQAAACx6dw/AAAAC0lEQVR42mNkAAMAAA4AAjOwv9wAAAAASUVORK5CYII="
                            data-src="//theme.hstatic.net/200000584705/1000969925/14/home_product_tab_item_banner_2.png" alt="Ghế ăn - Banner"/>
                </a>
                <a href="collections/tu-quan-ao.html" aria-label="Tủ quần áo">
                    <img class="lazyload w-100" width="1920" height="640"
                            src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAMAAAABCAQAAACx6dw/AAAAC0lEQVR42mNkAAMAAA4AAjOwv9wAAAAASUVORK5CYII="
                            data-src="//theme.hstatic.net/200000584705/1000969925/14/home_product_tab_item_banner_3.png" alt="Tủ quần áo - Banner"/>
                </a>
                <a href="collections/ke-treo-tuong.html" aria-label="Kệ treo tường">
                    <img class="lazyload w-100" width="1920" height="640"
                            src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAMAAAABCAQAAACx6dw/AAAAC0lEQVR42mNkAAMAAA4AAjOwv9wAAAAASUVORK5CYII="
                            data-src="//theme.hstatic.net/200000584705/1000969925/14/home_product_tab_item_banner_4.png" alt="Kệ treo tường - Banner"/>
                </a>
                <a href="collections/den-de-ban.html" aria-label="Đèn để bàn">
                    <img class="lazyload w-100" width="1920" height="640"
                            src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAMAAAABCAQAAACx6dw/AAAAC0lEQVR42mNkAAMAAA4AAjOwv9wAAAAASUVORK5CYII="
                            data-src="//theme.hstatic.net/200000584705/1000969925/14/home_product_tab_item_banner_5.png" alt="Đèn để bàn - Banner"/>
                </a>
            </div>
        </div>
...
{{-- itme --}}
                        <div class="product-item" data-id="1095039898" data-handle="ban-an-4-chan-cao-cap">
                            <div class="product-item-wrap">
                                <div class="product-item-image hasThumbs">
                                    <span class="product-item-discount">-14%</span>			
                                    <a class="product-item-link" href="products/ban-an-4-chan-cao-cap.html" aria-label="Bàn ăn 4 chân cao cấp">			
                                        <img class="lazyload w-100" width="480" height="480"
                                                src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII="
                                                data-src="../product.hstatic.net/200000584705/product/1_279c18d961424754a83cefcb8265f7da_26532009efc9498698848a917b01b363_large.png"
                                                alt="Bàn ăn 4 chân cao cấp">
                                        <img class="lazyload w-100" width="480" height="480"
                                                src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII="
                                                data-src="//product.hstatic.net/200000584705/product/2_2deb4589b2de4f16862a5ce8908eab92_0a6d229b7c954737ad3e86821423fc80_large.png" alt="Bàn ăn 4 chân cao cấp">						
                                    </a>
                                    <ul class="product-item-thumbs">
                                        <li>
                                            <a href="products/ban-an-4-chan-cao-cap.html" aria-label="Bàn ăn 4 chân cao cấp">
                                                <img class="w-100 lazyload" width="50" height="50"
                                                        src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII="
                                                        data-src="//product.hstatic.net/200000584705/product/2_2deb4589b2de4f16862a5ce8908eab92_0a6d229b7c954737ad3e86821423fc80_thumb.png" alt="Bàn ăn 4 chân cao cấp">
                                            </a>
                                        </li>
                                        <li>
                                            <a href="products/ban-an-4-chan-cao-cap.html" aria-label="Bàn ăn 4 chân cao cấp">
                                                <img class="w-100 lazyload" width="50" height="50"
                                                        src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII="
                                                        data-src="//product.hstatic.net/200000584705/product/3_422bbc35a1884281a26b5772222f3388_eb226959e4a1431f911b353796688e5f_thumb.png" alt="Bàn ăn 4 chân cao cấp">
                                            </a>
                                        </li>
                                        <li>
                                            <a href="products/ban-an-4-chan-cao-cap.html" aria-label="Bàn ăn 4 chân cao cấp">
                                                <img class="w-100 lazyload" width="50" height="50"
                                                        src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII="
                                                        data-src="//product.hstatic.net/200000584705/product/4_cb3516f04a8649cc9588074be6267627_6dae0b8598764b45b56f5f0e5ef21426_thumb.png" alt="Bàn ăn 4 chân cao cấp">
                                            </a>
                                        </li>
                                    </ul>
                                </div>
                                ...
                                <div class="product-item-detail">
                                    <div class="product-item-detail-info">
                                        <span class="product-item-detail-info-vendor">
                                            <a title="Show vendor" href="collections/vendors7610.html?q=f1genz">F1GENZ</a>				
                                        </span>
                                        <span class="product-item-detail-info-tag">Hot</span> 
                                    </div>
                                    <h3 class="product-item-detail-name">
                                        <a href="products/ban-an-4-chan-cao-cap.html" aria-label="Bàn ăn 4 chân cao cấp">Bàn ăn 4 chân cao cấp</a>
                                    </h3>
