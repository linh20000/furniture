    ...
    <div class="card-header">
        <div class="btn-group">
            <table>
                <tbody>
                <tr>
                    <form method="get" action="{{route('admin.minicategory.search')}}">
                        <td>
                        ...
                        <td><a class="btn btn-secondary" href="{{route('admin.minicategory')}}">Xóa tìm kiếm</a></td>
                    </form>
                </tr>
            </tbody>
        </table>
        ...
        <div class="dt-buttons btn-group">
            <a href="{{route('admin.minicreateCategory')}}" class="btn btn-secondary action-item" tabindex="0" aria-controls="table-categories">
                <span>
                ...
                <tbody>
                    ...
                    <tr id="row" class="text-center">
                        ...
                        <td class="project-actions text-right">
                            <a href="{{route('admin.minigetUpdateCategory',[$item->id])}}" class="btn btn-sm btn-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColror" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-edit font-medium-2 text-body">
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer justify-content-center">
                                    ...
                                    <a href="{{route('admin.minideleteCategory',[$item->id])}}"  type="button" class="btn btn-danger">Xóa</a>
                                </div>
                            </div>
                        </div>
                    </div>
