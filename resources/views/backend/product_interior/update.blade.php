                            ...
                            <div class="card card-primary">
                                ...
                                <div class="card-body">
                                        ...
                                        <div class="col-md-6">
                                         ...
                                         <div class="col-md-6">
                                             <div class="form-group mt-1 mb-1">
                                                ...
                                                <input type="text" id="trademark" name="trademark" value="{{$producy->trademark}}" class="form-control" placeholder="Nhập mã sản phẩm">
                                                @error('trademark')
                                                <span class="text-danger mt-1 d-block">{{ $message }}</span>
                                                @enderror
                                            </div>
                                    ...
                                    <div class="form-group mt-1 mb-1">
                                        ...
                                        <input type="number" id="percent_discount" name="percent_discount"  oninput="this.value = this.value.replace(/[^0-9.]/g, '')" min="0" max="100" value="{{($product->old_price - $product->sale_price) / $product->old_price * 100}}" class="form-control" placeholder="Nhập phần trăm giảm giá ">
                                    ...
                                    <div class="form-group mt-1 mb-1">
                                        ...
                                        <textarea class="form-control" id="summary-ckeditor-specifications" name="specifications">{{$product->specifications}}</textarea>
                                    ...
                                    <div class="row">
                                        <div class="col-md-2">
                                            <div class="form-group mt-1 mb-1">
                                                ...
                                                <input type="text" id="color_1" name="color_1" value="{{$item->color_1}}" class="form-control" placeholder="Nhập màu sắc">
                                            </div>
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group mt-1 mb-1">
                                                ...
                                                <input type="text" id="color_2" name="color_2" value="{{$item->color_2}}" class="form-control" placeholder="Nhập màu sắc">
                                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-2">
                                            <div class="form-group mt-1 mb-1">
                                                ...
                                                <input type="text" id="type_1" name="type_1" value="{{$item->type_1}}" class="form-control" placeholder="Nhập kiểu">
                                            </div>
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group mt-1 mb-1">
                                                ...
                                                <input type="text" id="type_2" name="type_2" value="{{$item->type_2}}" class="form-control" placeholder="Nhập kiểu">
                                            </div>
