                                ...
                                <div class="card card-primary">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group mt-1 mb-1">
                                                <label for="type_blog" class="form-label mb-1">Danh mục</label>
                                                    <select class="form-control custom-select" name="type_blog" id="type_blog" placeholder="">
                                                        <option value="blog_new">Tin tức chính</option>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group mt-1 mb-1">
                                                    <label for="status" class="form-label mb-1">Danh mục</label>
